...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MT.OnlineRestaurant.DataLayer.Context.TblFoodCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
                    ...
                    b.ToTable("tblFoodCart");
                });

            modelBuilder.Entity("MT.OnlineRestaurant.DataLayer.Context.TblFoodCartMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
                    ...
                    b.HasIndex("TblFoodCartId");

                    b.ToTable("tblFoodCartMapping");
                });
            ...
            modelBuilder.Entity("MT.OnlineRestaurant.DataLayer.Context.TblFoodCartMapping", b =>
                {
                    b.HasOne("MT.OnlineRestaurant.DataLayer.Context.TblFoodCart", "TblFoodCart")
                        .WithMany("TblFoodCartMapping")
                        .HasForeignKey("TblFoodCartId")
