...
namespace MT.OnlineRestaurant.SearchManagement.Controllers
{
    ...
    public class SearchController : Controller
    {
        ...
        [HttpGet]
        [Route("SearchForRestaurants")]
        public IActionResult SearchForRestaurants([FromBody] SearchForRestaurant searchDetails)
        {
            IQueryable<RestaurantInformation> restaurantDetails;
            restaurantDetails = business_Repo.SearchForRestaurants(searchDetails);
            if (restaurantDetails != null)
            {
                return this.Ok(restaurantDetails);
            }
